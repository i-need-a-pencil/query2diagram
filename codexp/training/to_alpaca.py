...
from codexp.common.utils import get_data_id, seed_everything
from codexp.generation.prompts import BasePrompt, DiagramsFinetunedPrompt


class Config:
    input_path = "./datasets/fixed_synth_final.json"
    sampled_ids_path = (
        "./datasets/sampled_ids.json"
    )
    output_path = (
