...
from codexp.common.types import Graph, SubscriptableBaseModel
from codexp.generation.generate_api import Config, generate
from codexp.generation.generate_utils import OpenAIEngine, OpenAIEngineConfig
from codexp.generation.prompts import DiagramsZeroShotPrompt
...
if __name__ == "__main__":
    ...
    output_path = "./datasets/Claude_base.json"
